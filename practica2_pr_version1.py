'''
Esta es una primera version, donde nos hemos limitado a resolver el problema 
utilizando monitores para gestionar el tráfico de los diferentes vehí­culos del puente.
Pero al hacerlo observamos que en algunos casos podemos tener problemas de inaniciónn.  
'''
import time
import random
...
SOUTH = 1
NORTH = 0
#Habria 25 coches en cada dirección, 50 en total cambiamos este número para que
...
class Monitor():
    ...
    def wants_enter_car(self, direction: int) -> None:
        ...
        if direction == NORTH:
            ...
            self.coches_norte.value += 1 # aumentamos el numero de coches en el puente
